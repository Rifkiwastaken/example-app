...
@section('title', 'Edit Benih Sumber - SIBESTI')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Edit Benih Sumber</h4>
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('plants.seed-sources.update', [$plant, $seed_source]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <select name="seed_class" class="form-select @error('seed_class') is-invalid @enderror" required>
                    ...
                    @foreach(\App\Models\SeedSource::KELAS_BENIH as $code => $label)
                        <option value="{{ $code }}" {{ old('seed_class', $seed_source->seed_class) === $code ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="origin_lot_number" maxlength="50"
                       ...
                       value="{{ old('origin_lot_number', $seed_source->origin_lot_number) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="origin_producer" maxlength="150"
                       ...
                       value="{{ old('origin_producer', $seed_source->origin_producer) }}" required>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <input type="number" name="quantity_kg" step="0.01" min="0.01"
                           ...
                           value="{{ old('quantity_kg', $seed_source->quantity_kg) }}" required>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="3" class="form-control">{{ old('description', $seed_source->description) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                @if($seed_source->file_path)
                    <small class="text-muted d-block mt-1">File tersimpan: {{ $seed_source->file_name }}</small>
                @endif
            </div>
