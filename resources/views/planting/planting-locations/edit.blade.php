...
@section('title', 'Edit Lokasi Penanaman - SIBIT')
...
@php
    $selectedResponsible = collect(old('responsible_contact_ids', $plantingLocation->responsibleContacts->pluck('id')->all()));
    $selectedLandManagers = collect(old('land_manager_contact_ids', $plantingLocation->landManagerContacts->pluck('id')->all()));
    $selectedLandWorkers = collect(old('land_worker_contact_ids', $plantingLocation->landWorkerContacts->pluck('id')->all()));
                    ...
                    <div class="mb-3">
                        ...
                        <select name="location_id" class="form-select @error('location_id') is-invalid @enderror" required>
                            ...
                            @foreach($locations as $location)
                                <option value="{{ $location->id }}" {{ old('location_id', $plantingLocation->location_id) == $location->id ? 'selected' : '' }}>
                                    {{ $location->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" name="google_maps_link" class="form-control @error('google_maps_link') is-invalid @enderror"
                               value="{{ old('google_maps_link', $plantingLocation->google_maps_link) }}" placeholder="https://maps.google.com/...">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div id="selectedContacts" class="mb-2">
                            @php
                                $oldContactIds = collect(old('responsible_contact_ids', $plantingLocation->responsibleContacts->pluck('id')->all()))->filter();
                            @endphp
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div id="selectedLandManagerContacts" class="mb-2">
                            @php
                                $oldLandManagerContactIds = collect(old('land_manager_contact_ids', $plantingLocation->landManagerContacts->pluck('id')->all()))->filter();
                            @endphp
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div id="selectedLandWorkerContacts" class="mb-2">
                            @php
                                $oldLandWorkerContactIds = collect(old('land_worker_contact_ids', $plantingLocation->landWorkerContacts->pluck('id')->all()))->filter();
                            @endphp
