        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" value="Aktif" disabled readonly>
                    <div class="form-text">Akun baru otomatis aktif dan siap digunakan</div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mt-2">
                        <input type="checkbox" class="form-check-input" id="primary_phone_is_whatsapp" 
                               name="primary_phone_is_whatsapp" value="1" {{ old('primary_phone_is_whatsapp', true) ? 'checked' : '' }}>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="province" id="province" class="form-control @error('province') is-invalid @enderror" 
                           placeholder="Tuliskan provinsi" value="{{ old('province', '') }}">
                    @error('province')
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="city" id="city" class="form-control @error('city') is-invalid @enderror" 
                           placeholder="Tuliskan kabupaten/kota" value="{{ old('city', '') }}">
                    @error('city')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="district" id="district" class="form-control @error('district') is-invalid @enderror" 
                           placeholder="Tuliskan kecamatan" value="{{ old('district', '') }}">
                    @error('district')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="village" id="village" class="form-control @error('village') is-invalid @enderror" 
                           placeholder="Tuliskan desa/kelurahan" value="{{ old('village', '') }}">
                    @error('village')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <textarea name="notes" id="notes" rows="4" class="form-control @error('notes') is-invalid @enderror" 
                      placeholder="Contoh: Ahli dalam pengendalian hama, dapat dihubungi di luar jam kerja, dsb.">{{ old('notes') }}</textarea>
            @error('notes')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
