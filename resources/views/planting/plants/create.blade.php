...
@section('title', 'Tambahkan Varietas Tanaman - SIBESTI')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Tambahkan Varietas Tanaman</h4>
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('plants.store') }}" id="plantForm" enctype="multipart/form-data">
            @csrf
                ...
                <div class="d-flex gap-2">
                    <select name="plant_type_id" id="plantTypeSelect" class="form-select @error('plant_type_id') is-invalid @enderror" required>
                        ...
                        @foreach($types as $type)
                            <option value="{{ $type->plant_type_id }}" {{ old('plant_type_id') == $type->plant_type_id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="variety" id="varietyInput" class="form-control @error('variety') is-invalid @enderror"
                       value="{{ old('variety') }}" placeholder="Contoh: Bujang Merantau, Inpari 32" required>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                          placeholder="Masukkan deskripsi varietas">{{ old('description') }}</textarea>
                @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            @include('planting.plants._agronomy-fields', ['plant' => null, 'harvestUnitRequired' => false])
