...
@section('title', 'Edit Lahan - ' . $plantingLocation->name . ' - SIBESTI')
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('planting-locations.fields.update', [$plantingLocation, $field]) }}">
            @csrf
            @method('PUT')
            @include('planting.planting-locations.fields._form', ['plantingLocation' => $plantingLocation, 'field' => $field])
